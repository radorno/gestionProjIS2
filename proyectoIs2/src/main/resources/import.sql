...
insert into tareas(CODIGO_TAREA,VERSION,PRIORIDAD,ESTADO,DESCRIPCION,OBSERVACION,CODIGO_PROYECTO,TAREA_PADRE,COD_LINEA_BASE) values('HIJO','V1','MAXIMA','INICIADO','CARGAR BANCOS','URGENTE',' ',' ','ONE')
insert into tareas(CODIGO_TAREA,VERSION,PRIORIDAD,ESTADO,DESCRIPCION,OBSERVACION,CODIGO_PROYECTO,TAREA_PADRE,COD_LINEA_BASE) values('PADRE','V1','MAXIMA','INICIADO','CARGAR BANCOS','URGENTE',' ',' ','ONE')
